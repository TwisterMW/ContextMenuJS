...
var ContextualMenu = function(menuList, menuLinks){
	...
	this.loadCSS = function(){
		...
		cssOutput += "\n\t.cm-option-list li{list-style:none;margin:0;padding:5px 10px;height:41px;border-bottom:1px solid #dfdfdf;transition:background 0.1s ease-in-out, color 0.1s ease-in-out;background:#fff;color:#333;vertical-align:top;}";
